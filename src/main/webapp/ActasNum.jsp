                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="menu-interna">
                            <ul>
                                ...
                                <li><a href="ActasNum.jsp" class="act-izq">Actas por número</a></li>
                            </ul>
                        </div>
                    </div>
		...
		<div class="tab-info-desc">
			<div class="row">
				<div class="col-xs-3 col-md-4">
					...
					Si requiere la imagen del acta, solicítela a través del procedimiento de acceso a la información pública. </div>
				</div>
