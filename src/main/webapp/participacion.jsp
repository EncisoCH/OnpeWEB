							...
							<div class="contenido-interna">
								...
								<% if ( id == null ) { %>
									<div class="col-xs-12 pbot30 ptop20">
										<div class="col-xs-12 col-md-6">
											<a href="svlParticipacion?id=Extranjero"><img src="images/ico-extranjero.jpg" class="img-responsive"></a>
										</div>
										<div class="col-xs-12 col-md-6">
											<a href="svlParticipacion?id=Nacional"><img src="images/ico-nacional.jpg" class="img-responsive"></a>
										</div>
									</div>
								<% } %>
